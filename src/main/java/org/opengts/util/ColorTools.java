...
public class ColorTools
{
    ...
    public static RGB ORANGE             = new RGB(0xFFA500);
    public static RGB YELLOW             = new RGB(0xFFD700);
    public static RGB DARK_YELLOW        = new RGB(0xAA9700);
    public static RGB GREEN              = new RGB(0x00CC00);
    public static RGB BLUE               = new RGB(0x0000EE);
    public static RGB PURPLE             = new RGB(0x9400D3);
    ...
    public static RGB CYAN               = new RGB(0x00FFFF);
    public static RGB PINK               = new RGB(0xFF1493);

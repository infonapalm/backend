    ...
    implements Comparable, Cloneable
{
  ...
  //public static final int MAY       = MAY;
    ...
    **/
    public static ParsedDateTime parseDateTime(String dateStr, TimeZone dftTZ, DefaultParsedTime dftTime)
    ...
    *** @throws DateParseException if an invalid date/time format was specified.
    **/
    public static DateTime parseArgumentDate(String dateStr, TimeZone dftTZ, DefaultParsedTime dftTime)
        throws DateParseException
    {

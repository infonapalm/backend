...
public class JSON
{
        ...
        throws JSONParsingException 
    {
        ...
        for (;ndx < len;) {
            ...
            if (ch == '\"') {
                ...
                index.set(ndx);
                _KeyValue kv = JSON.parse_KeyValue(v, index);
                ndx = (int)index.get();
                if (kv == null) {
    ...
    **/
    public static _KeyValue parse_KeyValue(String v, AccumulatorLong index)
        throws JSONParsingException 
    {
        int            ndx = (int)index.get();
        int            len = v.length();
        ...
        for (;ndx < len;) {
            ...
            if (ch == ':') {
                ...
                // JSON._Value
                index.set(ndx);
                _Value val = JSON.parse_Value(v, index);
                ndx = (int)index.get();
                if (val == null) {
    ...
    *** Parse JSON Value
    **/
    public static _Value parse_Value(String v, AccumulatorLong index)
        throws JSONParsingException 
    {
        int         ndx = (int)index.get();
        int         len = v.length();
        ...
        for (;ndx < len;) {
            ...
            if (ch == '[') {
                // JSON._Array
                index.set(ndx);
                _Array array = JSON.parse_Array(v, index);
                ndx = (int)index.get();
                if (array == null) {
            ...
            if (ch == '{') {
                // JSON._Object
                index.set(ndx);
                _Object obj = JSON.parse_Object(v, index);
                ndx = (int)index.get();
                if (obj == null) {
    ...
    *** Parse JSON Array
    **/
    public static _Array parse_Array(String v, AccumulatorLong index)
        throws JSONParsingException 
    {
        int         ndx   = (int)index.get();
        int         len   = v.length();
